...
namespace D11
{
    public abstract class BaseDraggable : MonoBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        /// The position update.
        /// </summary>
        protected Vector3 positionUpdate;

        /// <summary>
        /// The drag item transform.
        /// </summary>
        public  Transform draggingHandler;

        /// <summary>
        /// The drag item parent transform to revert.
        /// </summary>
        public Transform draggingHandlerParent;
        ...
        /// </summary>
        protected string canvasName = StaticStrings.DragCanvasName;

        /// <summary>
        /// Drag canvas sort order.
        /// </summary>
        protected int canvasSortOrder = 100;

        /// <summary>
        /// Main canvas render for drag item.
        /// </summary>
        protected RenderMode GameCanvasRenderMode;
        ...
        public virtual void UpdateParentHolder(Transform parent, bool isTakenCard)
        {
