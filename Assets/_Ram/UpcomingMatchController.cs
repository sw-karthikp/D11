...
public class UpcomingMatchController : MonoBehaviour
{
    [Header("Variables")]
    ...
    public void SetUpcomingMatchData(string _hotGame, string _id, string _teamA, string _teamB, string _time, string _type, string _teamAUrl, string _teamBUrl)
    {
        HotGame = _hotGame;
        ID= _id;
        TeamA= _teamA;
